...
char* getVersion()
{
	sprintf((char*)&fw_version[0], "%s", BODYVISIONVERSION);
...
// 10. GET_STATUS
static void proc_cmd_get_status(struct mg_connection* conn, const struct mg_request_info* request_info)
{
...
static void proc_cmd_load_uc_upgrade(struct mg_connection* conn, const struct mg_request_info* request_info)
{
}
